...
//   });
    ...
    console.log("schooltaskscompleted: "+schooltaskscompleted);
    console.log("schooltaskstotal: "+schooltaskstotal);
    console.log("worktaskscompleted: "+worktaskscompleted);
    console.log("worktaskstotal: "+worktaskstotal);
    console.log("othertaskscompleted: "+othertaskscompleted);
    console.log("othertaskstotal: "+othertaskstotal);
    main();
};
function main(){
